...
var ServiceFacade = require('int_worldpay_core/cartridge/scripts/service/ServiceFacade');
/**
...
function handleCardRedirect(basket, paymentInformation) {
    ...
    if (paymentMethod.equals(WorldpayConstants.WORLDPAY) && Site.getCurrent().getCustomPreferenceValue('WorldpayEnableTokenization') && basket.getCustomer().authenticated &&
        ...
        var matchedPaymentInstrument = require('int_worldpay_core/cartridge/scripts/common/PaymentInstrumentUtils').getTokenPaymentInstrument(paymentInstruments, cardNumber, cardType, expirationMonth, expirationYear);
...
function authorize(orderNumber, cardNumber, encryptedData, cvn) {
    ...
    var WorldpayPreferences = require('int_worldpay_core/cartridge/scripts/object/WorldpayPreferences');
    ...
    var currentpaymentinstrument = order.paymentInstrument;
    var transactionIdentifier;
    ...
    if (pi.paymentMethod.equals(PaymentInstrument.METHOD_CREDIT_CARD) || (pi.paymentMethod.equals(WorldpayConstants.WORLDPAY) && pi.getCreditCardToken())) {
        ...
        var TokenProcessUtils = require('int_worldpay_core/cartridge/scripts/common/TokenProcessUtils');
        return TokenProcessUtils.checkAuthorization(serviceResponse, pi, customerObj);
    }
    var Utils = require('int_worldpay_core/cartridge/scripts/common/Utils');
