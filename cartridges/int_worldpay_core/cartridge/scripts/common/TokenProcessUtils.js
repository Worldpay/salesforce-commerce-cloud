    ...
    if ((customerObj && responseData.authenticatedShopperID.valueOf().toString() === customerObj.profile.customerNo && responseData.cardNumber) || (tokenType)) {
        ...
        if (matchedPaymentInstrument == null) {
            ...
            Transaction.wrap(function () {
                matchedPaymentInstrument = require('int_worldpay_core/cartridge/scripts/common/PaymentInstrumentUtils').copyPaymentCardToInstrument(matchedPaymentInstrument, null, null, null, null, null, responseData.paymentTokenID.valueOf().toString());
            });
        }
    }
    return {
