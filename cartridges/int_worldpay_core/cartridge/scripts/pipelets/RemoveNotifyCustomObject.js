...
function removeNotifyCustomObject(customObjectID) {
    ...
    try {
      ...
      // Get Custom Object based on passed custom object id.
        ...
        var errorCode = require('int_worldpay_core/cartridge/scripts/common/WorldpayConstants').NOTIFYERRORCODE114;
        var errorMessage = require('int_worldpay_core/cartridge/scripts/common/Utils').getErrorMessage(errorCode);
