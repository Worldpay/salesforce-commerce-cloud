...
function getPaymentCardToken(customerPaymentInstruments, cardNumber, cardType, expirationMonth, expirationYear) {
    ...
    try {
        ...
        creditCardInstrument = require('int_worldpay_core/cartridge/scripts/common/PaymentInstrumentUtils').getTokenPaymentInstrument(customerPaymentInstruments, cardNumber, cardType, expirationMonth, expirationYear);
