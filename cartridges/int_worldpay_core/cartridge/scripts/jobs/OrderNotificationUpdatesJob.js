...
function alternateFlow(errorCount, errorList, errorMessage, orderNo, XMLString, customObjectID) {
  ...
  // GenerateErrorMessageForJob.js
    var generateErrorMessageForJobResult = require('int_worldpay_core/cartridge/scripts/pipelets/GenerateErrorMessageForJob').generateErrorMessageForJob(errorMessage, orderNo, XMLString, errorList);
    ...
    // SearchResultIterator
      ...
      // Expression
        ...
        // CheckWorldpayOrder.js
                var checkWorldpayOrderResult = require('int_worldpay_core/cartridge/scripts/pipelets/CheckWorldpayOrder').checkWorldpayOrder(order);
