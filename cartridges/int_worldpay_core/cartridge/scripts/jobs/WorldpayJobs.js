...
var UpdateOrderStatus = require('int_worldpay_core/cartridge/scripts/order/UpdateOrderStatus');
/**
...
function addOrUpdateToken(customerInformation, serviceResponse, cardNumber, cardType) {
  ...
  // Expression
    ...
    // GetPaymentcardToken to fetch the saved card based on card details found in service response
        var getPaymentCardTokenResult = require('int_worldpay_core/cartridge/scripts/pipelets/GetPaymentCardToken').getPaymentCardToken(customerPaymentInstruments, cardNumber, cardType, serviceResponse.cardExpiryMonth.valueOf(), serviceResponse.cardExpiryYear.valueOf());
      ...
      // found matched saved card
        ...
        // Expression
            if (!paymentTokenID) {
                ...
                Transaction.wrap(function () {
                    saveCustomerCreditCardResult = require('int_worldpay_core/cartridge/scripts/pipelets/SaveCustomerCreditCard').saveCustomerCreditCard(matchedCustomerPaymentInstrument, serviceResponse.paymentTokenID.valueOf().toString(), null, null, null, null, null);
                });
                return;
            }
        ...
        if (serviceResponse.cardNumber) {
          ...
          // SaveCustomerCreditCard
            saveCustomerCreditCardResult = require('int_worldpay_core/cartridge/scripts/pipelets/SaveCustomerCreditCard').saveCustomerCreditCard(createdPaymentInstrument,
...
function readCustomObject(customObjectID) {
    ...
    Transaction.wrap(function () {
        readNotifyCustomObjectResult = require('int_worldpay_core/cartridge/scripts/pipelets/ReadNotifyCustomObject').readNotifyCustomObject(customObjectID);
    });
...
function removeCustomObject(customObjectID) {
    ...
    Transaction.wrap(function () {
        removeCustomObjectResult = require('int_worldpay_core/cartridge/scripts/pipelets/RemoveNotifyCustomObject').removeNotifyCustomObject(customObjectID);
    });
