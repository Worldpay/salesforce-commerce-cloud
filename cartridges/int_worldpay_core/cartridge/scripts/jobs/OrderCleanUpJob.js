    ...
    if (ordersReturnedByQueryIterator.getCount() > 0) {
        ...
        Transaction.wrap(function () {
            while (ordersReturnedByQueryIterator.hasNext()) {
                ...
                var getCreatedOrderDetailsResult = require('int_worldpay_core/cartridge/scripts/pipelets/GetCreatedOrderDetails').getCreatedOrderDetails(orderReturnedByQuery);
