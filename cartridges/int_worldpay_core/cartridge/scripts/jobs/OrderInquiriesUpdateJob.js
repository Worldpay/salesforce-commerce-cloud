...
function orderInquiriesUpdate() {
    ...
    var worldPayJobs = require('int_worldpay_core/cartridge/scripts/jobs/WorldpayJobs');
  ...
  // Expression
    ...
    // Object Iterator
      ...
      // CheckWorldpayOrder
            var checkWorldpayOrderResult = require('int_worldpay_core/cartridge/scripts/pipelets/CheckWorldpayOrder').checkWorldpayOrder(orderReturnedByQuery);
      ...
      // Expression
            if (!checkWorldpayOrderResult.WorldpayOrderFound) {
                ...
                sendWorldpayOrderInquiriesRequestResult = require('int_worldpay_core/cartridge/scripts/pipelets/SendWorldpayOrderInquiriesRequest').sendWorldpayOrderInquiriesRequest(orderReturnedByQuery, paymentInstr);
                    ...
                    if (!errorCode && serviceResponse != null) {
                        ...
                        if (!(orderReturnedByQuery.custom.WorldpayLastEvent && orderReturnedByQuery.custom.WorldpayLastEvent.equalsIgnoreCase(updateStatus))) {
                            ...
                            if (!flag) {
                                ...
                                generateErrorMessageForJobResult = require('int_worldpay_core/cartridge/scripts/pipelets/GenerateErrorMessageForJob').generateErrorMessageForJob(errorMessage, orderNo, null, errorList);
    ...
    // Expression
      ...
      // WriteToNotifyLog.js
            var writeToNotifyLogResult = require('int_worldpay_core/cartridge/scripts/pipelets/WriteToNotifyLog').writeToNotifyLog(errorList);
