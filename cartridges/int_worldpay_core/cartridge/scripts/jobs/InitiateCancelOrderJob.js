  ...
  // Expression
    ...
    // Object Iterator
      ...
      // InitiateCancelOrder.js
            initiateCancelOrderResult = require('int_worldpay_core/cartridge/scripts/pipelets/InitiateCancelOrder').initiateCancelOrder(orderNo);
      ...
      // PIPELEXT_NEXT
        ...
        // Expression
                if (!errorCode && serviceresponse != null) {
                    ...
                    updateTransactionStatusResult = require('int_worldpay_core/cartridge/scripts/order/UpdateTransactionStatus').updateTransactionStatus(orderReturnedByQuery, false);
                }
