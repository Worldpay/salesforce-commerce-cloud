...
function sendWorldpayOrderInquiriesRequest(orderObject, PaymentInstrument) {
    ...
    var orderInquiryRequestResult = require('link_worldpay_core/cartridge/scripts/service/ServiceFacade').orderInquiryRequestService(paymentMthd, orderObject, merchantID);
    if (orderInquiryRequestResult.error) {
        ...
        Transaction.wrap(function () {
            require('link_worldpay_core/cartridge/scripts/common/PaymentInstrumentUtils').updatePaymentInstrumentToken(orderInquiryRequestResult.response, PaymentInstrument);
        });
    }
