...
function apmLookupService() {
    ...
    if (request.httpParameterMap.billingCountry.value && paymentAmount > 0) {
        ...
        var applicablePMResult = require('link_worldpay_core/cartridge/scripts/order/WorldpayPayment').applicablePaymentMethods(paymentMethods, request.httpParameterMap.billingCountry.value, preferences);
