...
describe('Place Order - Alipay Payment Method', function () {
    this.timeout(25000);
        ...
        return request(myRequest)
            ...
            .then(function (csrfResponse) {
                ...
                myRequest.form = {
                    ...
                    dwfrm_billing_paymentMethod: 'ALIPAY-SSL'
                };
                return request(myRequest);
            })
    ...
    it('positive test for Alipay Payment Method', function () {
        ...
        return request(myRequest)
            ...
            .then(function (response) {
                ...
                assert.equal((bodyAsJson.continueUrl).includes('paymentMethod=ALIPAY'), true, 'Expected payment method should be displayed.');
