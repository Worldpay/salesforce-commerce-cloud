...
describe('Place Order - ERROR Credit Card Payment Method', function () {
    this.timeout(25000);
        ...
        return request(myRequest)
            ...
            .then(function (csrfResponse) {
                ...
                myRequest.form = {
                    ...
                    dwfrm_billing_creditCardFields_cardType: testData.creditCardError.cardType,
                    dwfrm_billing_creditCardFields_cards: testData.creditCardError.cardName,
                    dwfrm_billing_creditCardFields_cardOwner: testData.creditCardError.cardOwner,
                    dwfrm_billing_creditCardFields_cardNumber: testData.creditCardError.number,
                    dwfrm_billing_creditCardFields_expirationMonth: testData.creditCardError.monthIndex,
                    dwfrm_billing_creditCardFields_expirationYear: testData.creditCardError.yearIndex,
                    dwfrm_billing_creditCardFields_securityCode: testData.creditCardError.cvn
                };
                return request(myRequest);
            })
    ...
    it('positive test for ERROR Credit Card', function () {
