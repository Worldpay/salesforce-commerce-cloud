...
describe('Place Order - Redirect Credit Card Payment Method', function () {
    this.timeout(25000);
        ...
        return request(myRequest)
            ...
            .then(function (csrfResponse) {
                ...
                myRequest.form = {
                    ...
                    dwfrm_billing_paymentMethod: 'Worldpay',
                    dwfrm_billing_creditCardFields_cards: testData.creditCardVisa.cardName
                };
                return request(myRequest);
            })
    ...
    it('positive test for Redirect Credit Card', function () {
        ...
        return request(myRequest)
            ...
            .then(function (response) {
                ...
                assert.equal((bodyAsJson.redirectUrl).includes('worldpay.com'), true, 'Expected redirect url should be displayed.');
            });
    });
});
