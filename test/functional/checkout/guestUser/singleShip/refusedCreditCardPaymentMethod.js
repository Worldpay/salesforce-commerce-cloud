...
describe('Checkout - Review page for REFUSED41 Credit Card Payment Method', () => {
    ...
    before(() => {
        return testDataMgr.load()
            .then(() => {
                const creditCard = testData.creditCardRefused;
            ...
            .then(() => browser.url(config.baseUrl + '/home'))
    ...
    describe('Error Message', () => {
        it('should display error message', () => {
            return browser.getText('.error-message-text')
                .then((errorMsg) => {
                    console.log('Error Scenario test case using REFUSED41 Credit Card'); // eslint-disable-line
                    const expectedErrorMsg = 'Lost card.';
