...
describe('Checkout - Order confirmation page for Direct Credit Card Payment Method', () => {
    ...
    before(() => {
        return testDataMgr.load()
            ...
            .then(() => browser.getText(orderConfPage.ORDER_NUMBER)
                .then((orderNumber) => {
                    console.log('Required Order Number using Direct Credit Card is : ' + orderNumber); // eslint-disable-line
                }));
    });
