...
@Guest_ReDirectOrder_Normal_JCB_Error. NUI
    Scenario: Guest User is able to place order via normal JCB Card in Re-Direct Method
		...
		And Shopper fills email, phone number & preferred card for HPP on new ui
        ...
        |NUI Guest HPP Normal JCB Error.|

@Guest_ReDirectOrder_Normal__Master_Error. NUI
    Scenario: Guest User is able to place order via normal JCB Card in Re-Direct Method
	 	Given shopper selects yes or no for tracking consent on refarch
    	Then Shopper searches for "Hammered Gold Earrings"
		Then User add the product to cart and click to Checkout
		...
		And Apm verify for NUI error scenerios
        |NUI Guest HPP Normal Master Error.|

@Guest_ReDirectOrder_3D_Amex_Error. NUI
    Scenario: Guest User is able to place order via 3D Amex Card in re-Direct Method
		...
		And Apm verify for NUI error scenerios
        |NUI Guest HPP 3D Amex Error.|

@Guest_ReDirectOrder_3DS1_Master_Error. NUI
    Scenario: Guest User is able to place order via 3DS! Master Card in Re-Direct Method
		...
		And Apm verify for NUI error scenerios
        |NUI Guest HPP 3DS1 Master Error.|

@Guest_ReDirectOrder_3DS2_Frictionless_VisaPurchase_Error. NUI
    Scenario: Guest User is able to place order via Diners Card in Direct Method
		...
		And Apm verify for NUI error scenerios
        |NUI Guest HPP 3DS2 Frictionless Visa Purchase Error.|