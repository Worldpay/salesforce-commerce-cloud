...
module.exports = {
    ...
    addNewPayment() {
        I.waitForElement({ xpath: "//a[@aria-label='Add New Payment']" }, 10);
        I.click({ xpath: "//a[@aria-label='Add New Payment']" });
    },

    fillCardDetailsAccount(cardHolderName, cardNumber, expMonth, expYear) {
        I.waitForElement('#cardnamemyaccount', 20);
        ...
        I.waitForElement(this.locators.accountPaymentSaveButton, 5);
    ...
    enterCardDetailsGuest(PhonenNo, cardHolderName, cardNumber, expMonth, expYear, securityCode) {
        I.fillField('#phoneNumber', PhonenNo);
        I.fillField('#cardOwner', cardHolderName);
        I.fillField('#cardNumber', cardNumber);
        I.wait(2);
    ...
    fillPhoneNoReDirectNUI(PhoneNo, preferredCard) {
        I.wait(1);
        I.click('Hosted Payment Page');
        I.wait(1);
        I.fillField('#phoneNumber', PhoneNo);
    ...
    fillCardDetailsSave(PhonenNo, cardHolderName, cardNumber, expMonth, expYear, securityCode) {
        I.waitForElement('#phoneNumber');
        I.fillField('#phoneNumber', PhonenNo);
        I.fillField('#cardOwner', cardHolderName);
        I.fillField('#cardNumber', cardNumber);
        I.wait(2);
    ...
    fillEmailIDandPhoneNoDirect(PhoneNo, cvv) {
        let ccField;
        if (ccField = I.seeElement('#saved-payment-security-code')) {
            I.fillField('#phoneNumber', PhoneNo);
            I.fillField('#saved-payment-security-code', cvv);
