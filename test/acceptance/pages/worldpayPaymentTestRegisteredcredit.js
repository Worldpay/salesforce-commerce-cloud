...
module.exports = {
	...
	addToCart() {
		...
		I.wait(2);
		I.waitForElement('.add-to-cart-messages');
		I.seeTextEquals('Product added to basket','.add-to-cart-messages');
	...
	{
		I.waitForElement({xpath :"//select[@id='shippingCountry']"});
		I.selectOption({xpath :"//select[@id='shippingCountry']"},country);
		
	},
	selectState(state)
	{
		I.waitForElement({xpath :"//select[@id='shippingState']"});
		I.selectOption({xpath :"//select[@id='shippingState']"},state);
		I.wait(5);
	},
	filladdress(firstName,lastName,streetAddress1,streetAddress2,city,postalCode,phoneNumber)
	{
		I.waitForElement({xpath :"//input[@id='shippingFirstName']"});

		I.fillField({xpath :"//input[@id='shippingFirstName']"},firstName);
	
		I.fillField({xpath :"//input[@id='shippingLastName']"},lastName);
		
		//I.fillField('#shippingLastName',lastName);
		I.fillField('#shippingAddressOne',streetAddress1);
		
		I.fillField('#shippingAddressTwo',streetAddress2);
	
		I.fillField('#shippingAddressCity',city);
		
		I.fillField('#shippingZipCode',postalCode);
		I.fillField('#shippingPhoneNumber',phoneNumber);
		I.wait(2);
		I.seeCheckboxIsChecked('#shippingMethod-001');
		I.wait(1);
		// I.dontSeeeCheckboxIsChedcked('This is a Gift');
	...
	{
		I.waitForEnabled('.textbox.required.cardNumber');
		I.fillField('.textbox.required.cardNumber',cardNumber1);
