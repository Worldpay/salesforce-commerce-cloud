...
module.exports = {
    ...
    I.waitForEnabled({xpath:'//*[@id="ext-gen44"]/body/div/div[2]/div[2]/div/div[2]/div[2]/form[1]/button'});
    I.click({xpath:'//*[@id="ext-gen44"]/body/div/div[2]/div[2]/div/div[2]/div[2]/form[1]/button'});
   
    
  },
  paypalRegistered(email, phone, country)  {
    I.waitForElement({xpath: '//*[@id="dwfrm_billing"]/fieldset[1]/div/div[2]/a[1]'});
    I.wait(2);
    I.click({xpath: '//*[@id="dwfrm_billing"]/fieldset[1]/div/div[2]/a[1]'});
      I.wait(2);
...
fillShipping(firstName,lastName,addressOne,addressTwo,country,state,city,zipCode,phone){
    I.waitForEnabled('#shippingFirstName');
    I.waitForEnabled('#shippingLastName');
    I.waitForEnabled('#shippingAddressOne');
    I.waitForEnabled('#shippingAddressTwo');
    I.waitForEnabled('#shippingCountry');
    I.waitForEnabled('#shippingState');
    I.waitForEnabled('#shippingAddressCity');
    I.waitForEnabled('#shippingZipCode');
    I.waitForEnabled('#shippingPhoneNumber');
    I.waitForEnabled('.submit-shipping');
    I.fillField('#shippingFirstName',firstName);
    I.fillField('#shippingLastName',lastName);
    I.fillField('#shippingAddressOne',addressOne);
    I.fillField('#shippingAddressTwo',addressTwo);
    I.selectOption('#shippingCountry',country);
    I.selectOption('#shippingState',state);
    I.fillField('#shippingAddressCity',city);
    I.wait(1);
    I.fillField('#shippingZipCode',zipCode);
    I.wait(5);
    I.fillField('#shippingPhoneNumber',phone);
    I.wait(2);
